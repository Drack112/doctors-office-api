  ...
  public async up (queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      INSERT INTO modules VALUES
        ...
        ('${randomUUID()}', 'Doctors schedules by doctorId', 'Doctors schedules by doctorId management', '/doctors/schedules/:doctorId', CURRENT_TIMESTAMP, null),
        ...
        ('${randomUUID()}', 'Medical Records Images', 'Medical records images management', '/medical-records-images', CURRENT_TIMESTAMP, null),
